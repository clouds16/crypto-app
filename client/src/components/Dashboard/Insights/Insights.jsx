      ...
      <div className="container px-6 py-4 mx-auto">
        ...
        <div className="text-xs overflow-auto max-h-96">
          <div className="rounded-lg flex flex-col sm:flex-row ">
            <span className="w-full sm:w-1/2 h-12 relative px-3 py-1 font-semibold text-yellow-900 leading-tight flex items-center justify-center">
            ...
            {user?.result.coins > 100000 ?
              <span className="mt-2 sm:mt-0 ml-0 sm:ml-2 w-full sm:w-1/2 h-12 relative px-3 py-1 font-semibold text-green-900 leading-tight flex items-center justify-center">
              ...
              :
              <span className="mt-2 sm:mt-0 ml-0 sm:ml-2 w-full sm:w-1/2 h-12 relative px-3 py-1 font-semibold text-red-900 leading-tight flex items-center justify-center">
