				...
				<div className="md:flex md:items-center md:justify-between">
					...
					<div className={menuHidden ? "flex-1 md:flex md:items-center md:justify-between hidden" : "flex-1 md:flex md:items-center md:justify-between"}>
						<div className="flex flex-col -mx-4 md:flex-row md:items-center md:mx-8">
							...
							<NavLink onClick={() => setMenuHidden(true)} exact to="/about" activeClassName="text-purple-500 dark:text-purple-400 font-bold" className="px-2 py-1 mx-2 mt-2 text-sm font-medium text-gray-700 transition-colors duration-200 transform rounded-md md:mt-0 dark:text-gray-200 hover:bg-gray-300 dark:hover:bg-gray-700">About</NavLink>
