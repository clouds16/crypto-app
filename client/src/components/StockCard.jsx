  ...
  return (
    <div key={stock._id} className="max-w-xs mx-auto overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-900 mt-4">
      ...
      <div className="py-5 text-center flex items-center justify-center">
        ...
        <Link to={`/stock/${stock._id}`} className="ml-4 w-1/3 px-4 py-2 font-medium tracking-wide text-white capitalize transition-colors duration-200 transform bg-gray-500 rounded-md dark:bg-gray-800 hover:bg-gray-600 dark:hover:bg-gray-700 focus:outline-none focus:bg-gray-500 dark:focus:bg-gray-700">
          Details
        </Link>
      </div>
    </div>
